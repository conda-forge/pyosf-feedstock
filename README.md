About pyosf-feedstock
=====================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyosf-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4114&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyosf-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyosf` can be installed with `conda`:
...
It is possible to list all of the versions of `pyosf` available on your platform with `conda`:
...
```
mamba search pyosf --channel conda-forge
```
...
mamba repoquery search pyosf --channel conda-forge

# List packages depending on `pyosf`:
mamba repoquery whoneeds pyosf --channel conda-forge

# List dependencies of `pyosf`:
mamba repoquery depends pyosf --channel conda-forge
```
